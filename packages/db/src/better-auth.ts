...
import { getYdb, queryClientForYdb } from "./index.js";
...
/** Shared same-origin authentication defaults for generated services and AI sessions. */
export function createYdbAuth(appName: string, secret: string) {
  return betterAuth({
    appName,
    secret,
    baseURL: {
