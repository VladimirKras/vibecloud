...
imported component object through `data`. Never guess an icon name — image
search and `gravity-ui.com/icons` provide candidates, while the installed
`@gravity-ui/icons/index.d.ts` decides what can be imported. See
`references/icons.md`.
